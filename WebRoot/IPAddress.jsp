...
<html lang="en">
  ...
  <form id="form">
    <table>
    	...
    	<tr><td></td><td>申请数量:</td><td><input type="text" name="ipAddressApply.quantity"/></td><td>使用地点:</td><td><input type="text" name="ipAddressApply.address"/></td></tr>
    	<tr><td colspan="5">基本内容:</td></tr>
    	<tr><td></td><td>网口号码:</td><td><input type="text" name="ipAddressApply.portNumber"/></td><td>使用时间:</td><td><input onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" name="ipAddressApply.timeLimit"/></td></tr>
